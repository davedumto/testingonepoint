...
export function getProvider(key: string): OAuthProvider | null {
  const providers: Record<string, () => OAuthProvider> = {
    ghl: () => ({
      ...
      scopes: 'contacts.readonly contacts.write calendars.readonly calendars.write calendars/events.readonly calendars/events.write conversations.readonly conversations.write conversations/message.readonly conversations/message.write opportunities.readonly',
