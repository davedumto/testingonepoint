...
function ResetForm() {
  ...
  if (!token) return (
    <div className="card" style={{ textAlign: 'center' }}>
      ...
      <Link href="/employee/forgot-password" style={{ display: 'inline-block', marginTop: 16, fontSize: 14, fontWeight: 600, color: 'var(--teal)' }}>Request new link</Link>
    </div>
  );
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setSuccess(true); setTimeout(() => router.push('/employee/login'), 3000);
